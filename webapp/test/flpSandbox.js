		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice Lists",
									"targetURL": "#invoicelistsinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicelistsinvoices-display": {
								"semanticObject": "invoicelistsinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoicelists.invoices",
									"url": sap.ui.require.toUrl("invoicelists/invoices")
								}
							}
						}
					}
